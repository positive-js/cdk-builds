...
export declare function isControl(event: KeyboardEvent): boolean;
export declare function isNumberKey({ keyCode }: KeyboardEvent): boolean;
export declare function isLetterKey({ keyCode }: KeyboardEvent): boolean;
export declare function isFunctionKey({ keyCode }: KeyboardEvent): boolean;
export declare function isVerticalMovement({ keyCode }: KeyboardEvent): boolean;
export declare function isHorizontalMovement({ keyCode }: KeyboardEvent): boolean;
...
export declare function isInput(event: any): boolean;
export declare function isLeftBracket(event: KeyboardEvent): boolean;
export declare function isRightBracket(event: KeyboardEvent): boolean;
export declare function isDigit({ keyCode }: KeyboardEvent): boolean;
export {};
