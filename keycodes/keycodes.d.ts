...
export declare function isFunctionKey(event: any): boolean;
export declare function isVerticalMovement(event: any): boolean;
export declare function isHorizontalMovement(event: any): boolean;
export declare function isSelectAll(event: any): boolean;
export declare function isCopy(event: any): boolean;
export declare function isInput(event: any): boolean;
export declare function isLeftBracket(event: any): boolean;
export declare function isRightBracket(event: any): boolean;
export declare function isDigit(event: any): boolean;
export {};
