...
var BreakpointObserver = /** @class */ (function () {
    ...
    function (query) {
        ...
        function (listener) {
             ...
             * @return {?}
             */
            function () { return listener(e); })); });
            mql.addListener(queryListener);
        }), (/**
         * @return {?}
         */
        function () { return mql.removeListener(queryListener); }))
            .pipe(operators.takeUntil(this._destroySubject), operators.startWith(mql), operators.map((/**
         * @param {?} nextMql
         * @return {?}
         */
        function (nextMql) { return ({ query: query, matches: nextMql.matches }); })));
