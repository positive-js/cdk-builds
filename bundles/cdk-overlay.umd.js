...
OverlayConfig = /** @class */ (function () {
    function OverlayConfig(config) {
        ...
        if (config) {
             ...
             * @return {?}
             */
            function (key) { return config[key] !== undefined; }))
                .forEach((/**
             * @param {?} key
             * @return {?}
             */
    ...
    function () {
        ...
        if (this._config && this._config.threshold && this._config.threshold > 1) {
            ...
            function () {
                ...
                if (Math.abs(scrollPosition - _this._initialScrollPosition) > (/** @type {?} */ ((/** @type {?} */ (_this._config)).threshold))) { //tslint:disable-line
                    _this._detach();
                }
                else {
...
OverlayRef = /** @class */ (function () {
    ...
    function () {
        ...
        (/** @type {?} */ (this._host.parentElement)).insertBefore(this._backdropElement, this._host); //tslint:disable-line
    ...
    function () {
        ...
        if (backdropToDetach) {
             ...
             * @return {?}
             */
            function () { return setTimeout(finishDetach_1, 500); })); //tslint:disable-line
        }
    };
...
FlexibleConnectedPositionStrategy = /** @class */ (function () {
    ...
    function (positions) {
        ...
        if (positions.indexOf((/** @type {?} */ ((/** @type {?} */ (this))._lastPosition))) === -1) { //tslint:disable-line
...
var OverlayPositionBuilder = /** @class */ (function () {
    function OverlayPositionBuilder(_viewportRuler, _document, _platform) {
        this._viewportRuler = _viewportRuler;
        this._document = _document;
        this._platform = _platform;
    }
...
var CdkConnectedOverlay = /** @class */ (function () {
    ...
    function () {
         ...
         * @return {?}
         */
        function (position) { return _this.positionChange.emit(position); }));
        return strategy;
    };
    /**
    ...
    function () {
        ...
        if (!this._overlayRef) {
            this._createOverlay();
            (/** @type {?} */ (this._overlayRef)).keydownEvents().subscribe((/**
             * @param {?} event
             * @return {?}
             */
            function (event) {
