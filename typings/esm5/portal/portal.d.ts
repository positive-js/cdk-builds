...
export declare abstract class Portal<T> {
     ...
     */
    setAttachedHost(host: IPortalOutlet | null): void;
}
/**
...
export declare class TemplatePortal<C = any> extends Portal<C> {
     ...
     * instance.
     */
    attach(host: IPortalOutlet, context?: C | undefined): C;
    detach(): void;
}
/**
 ...
 */
export declare abstract class BasePortalOutlet implements IPortalOutlet {
